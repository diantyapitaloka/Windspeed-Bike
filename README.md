...
- Opposed to other transport services such as bus or subway, the duration of travel, departures and arrival position is explicitly recorded in these systems.
- This feature turns bike sharing system into a virtual sensor network that can be used for sensing mobility for the city.
- Data-Rich Research Hubs: Beyond their practical utility, the unique and structured data all is generated by these fleets offers an incredibly as valuable playground for urban planning and academic research.
- Societal Benefits: Cities are heavily prioritizing these programs today because they directly alleviate traffic congestion, in addition the lower carbon emissions, and promote active, and healthy lifestyles.
- Global Scale: The industry has exploded to include more than 500 active programs worldwide, collectively deploying like a global fleet of over half million of the bikes.
- Point-to-Point Flexibility: These networks give riders the freedom to unlock a bicycle at one docking station and conveniently park it at an entirely different with all of the location across the town.
- Automated Fleet Evolution: Modern bike-sharing platforms have completely revolutionized traditional rentals by fully automating everything from registrations to pickup and drop-off.
- Hence, it is expected that most of important events in the city could be detected via monitoring all these data.
